...
*/
Vue.component("simple_footer_component_1722794210", {
    template: `
    <footer id="footer-section" class="flex-1 bg-gradient-to-r from-pink-500 via-purple-500 to-black bg-opacity-50 backdrop-filter backdrop-blur-lg rounded-lg shadow-lg">
            <div id="footer-container" class="max-w-screen-xl p-6 py-8 mx-auto lg:py-16 md:p-10 lg:p-12">
                ...
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-lg text-center text-white">
                        Stay up-to-date with the latest Ethereum transactions across the network. EtherScan makes it easy to monitor and analyze new transaction activity as it happens.
                    </div>
                </div>
            </div>
        </footer> 
